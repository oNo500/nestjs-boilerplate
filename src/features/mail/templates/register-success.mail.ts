...
<html lang="en">
  ...
  <body style="background-color:#efeff1;margin:0;padding:0;">
    <div style="max-width:580px;margin:30px auto;background:#fff;padding:30px;">
      ...
      <p style="font-size:14px;line-height:1.5;color:#333;margin:16px 0;">Welcome to <strong>${APP_NAME}</strong>,</p>
      ...
      <p style="font-size:14px;line-height:1.5;margin:16px 0;">Thanks,<br />${APP_NAME} Support Team</p>
    </div>
